...
//Verifica se o usuario pressionou alguma telca
...
function moveJogador(){
    ...
    if(jogo.pressionou[TECLA.sapace]){
        disparo();
    }
...
function explosao2(inimigo2X,inimigo2Y){
    ...
    div2.animate({with:200, opacity:0}, "slow");
